...
COMMANDS = {
    ...
    "aptx_96k": (device.decode_aptx_96k_support, lambda r: {"enabled": r}),
    "aptx_lossless": (device.decode_aptx_lossless_support, lambda r: {"enabled": r}),
    "local_name": (device.decode_local_name, lambda r: {"name": r}),
    "eco_mode": (battery.decode_eco_mode, lambda r: {"enabled": r}),
    "battery_protection": (battery.decode_battery_protection, lambda r: {"enabled": r}),
    "auto_pause": (anc.decode_auto_pause, lambda r: {"value": r[0], "name": r[1]}),
